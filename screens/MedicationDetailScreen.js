...
const MedicationDetailScreen = () => {
  ...
  useEffect(() => {
    const fetchActivity = async () => {
      try {
        ...
        if (error) {
          console.error('Error fetching medication activity:', error);
        } else {
          setActivity(data);
          setDog(data.dogs);
        }
  ...
  const handleEditActivity = () => {
    navigateToActivityEdit(navigation, activityId, 'medication');
  };
  ...
  if (!activity) {
    return (
      <SafeAreaView style={styles.errorContainer}>
        <Text style={styles.errorText}>Medication record not found</Text>
        <TouchableOpacity 
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.activityHeader}>
          <View style={styles.activityIconContainer}>
            <ActivityIcon type="medication" size={32} />
          </View>
        ...
        {activity?.medication_name && (
          <View style={styles.detailSection}>
            ...
            <View style={styles.detailRow}>
              <FontAwesome5 name="pills" size={18} color="#6B7280" style={styles.detailIcon} />
              <Text style={styles.detailText}>{activity.medication_name}</Text>
            </View>
          </View>
        )}
        ...
        {activity?.dosage && (
          <View style={styles.detailSection}>
            ...
            <View style={styles.detailRow}>
              <FontAwesome5 name="prescription-bottle" size={18} color="#6B7280" style={styles.detailIcon} />
              <Text style={styles.detailText}>{activity.dosage}</Text>
            </View>
          </View>
        )}
        ...
        {activity?.frequency && (
          <View style={styles.detailSection}>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailText}>{activity.frequency}</Text>
            </View>
          </View>
        )}
