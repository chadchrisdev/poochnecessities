...
const FeedingDetailScreen = () => {
  ...
  useEffect(() => {
    const fetchActivity = async () => {
      try {
        ...
        if (error) {
          console.error('Error fetching feeding activity:', error);
        } else {
          setActivity(data);
          setDog(data.dogs);
        }
  ...
  const handleEditActivity = () => {
    navigateToActivityEdit(navigation, activityId, 'feeding');
  };
  ...
  if (loading) {
    return (
      <SafeAreaView style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>Loading feeding details...</Text>
      </SafeAreaView>
    );
  }
  ...
  if (!activity) {
    return (
      <SafeAreaView style={styles.errorContainer}>
        <Text style={styles.errorText}>Feeding record not found</Text>
        <TouchableOpacity 
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.activityHeader}>
          <View style={styles.activityIconContainer}>
            <ActivityIcon type="feeding" size={32} />
          </View>
        ...
        {activity?.amount && (
          <View style={styles.detailSection}>
            ...
            <View style={styles.detailRow}>
              <FontAwesome5 name="utensils" size={18} color="#6B7280" style={styles.detailIcon} />
              <Text style={styles.detailText}>{activity.amount}</Text>
            </View>
          </View>
        )}
        ...
        {activity?.food_type && (
          <View style={styles.detailSection}>
            ...
            <View style={styles.detailRow}>
              <FontAwesome5 name="bone" size={18} color="#6B7280" style={styles.detailIcon} />
              <Text style={styles.detailText}>{activity.food_type}</Text>
            </View>
          </View>
        )}
...
export default FeedingDetailScreen; 